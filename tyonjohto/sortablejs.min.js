  ...
  function k(t, e, n, o, i) {
    if (t.getBoundingClientRect || t === window) {
      ...
      return (
        o &&
          t !== window &&
          ((o = (e = v(i || t)) && e.a), (t = e && e.d), e && ((s = (a /= t) + (u /= t)), (c = (l /= o) + (d /= o)))),
    ...
    return {
          ...
          this.options.animation &&
            [].slice.call(this.el.children).forEach(function (t) {
              ...
              "none" !== P(t, "display") &&
                ...
                !t.thisAnimationDuration || ((n = v(t, !0)) && ((e.top -= n.f), (e.left -= n.e))),
                (t.fromRect = e));
            });
      },
      ...
      animate: function (t, e, n, o) {
        ...
        o &&
          ...
          P(t, "transition", "transform " + o + "ms" + (this.options.easing ? " " + this.options.easing : "")),
      ...
      pluginEvent: function (e, n, o) {
        ...
        H.forEach(function (t) {
          n[t.pluginName] &&
            ...
            n.options[t.pluginName] && n[t.pluginName][e] && n[t.pluginName][e](M({ sortable: n }, o)));
        });
      },
  ...
  (Bt.prototype = {
        ...
        if (
          ...
          if (((nt = B(l)), (it = B(l, t.draggable)), "function" == typeof c)) {
            if (c.call(this, e, l, this))
              return (
                U({ sortable: n, rootEl: s, name: "filter", targetEl: l, toEl: o, fromEl: o }),
                z("filter", n, { evt: e }),
            ...
            (c =
              ...
              c.split(",").some(function (t) {
                if ((t = N(s, t.trim(), o, !1)))
                  return (
                    U({ sortable: n, rootEl: t, name: "filter", targetEl: l, fromEl: o, toEl: o }),
                    z("filter", n, { evt: e }),
                    !0
                  );
              }))
    ...
    _prepareDragStart: function (t, e, n) {
      ...
      n &&
        ...
        (J = n),
        (at = a.group),
        (st = { target: (Bt.dragged = q), clientX: (e || t).clientX, clientY: (e || t).clientY }),
        ...
        s && this.nativeDraggable && ((this.options.touchStartThreshold = 4), (q.draggable = !0)),
    ...
    _emulateDragOver: function () {
      if (ct) {
        ...
        for (
          ...
          t && t.shadowRoot && (t = t.shadowRoot.elementFromPoint(ct.clientX, ct.clientY)) !== e;
        ...
        if ((q.parentNode[j]._isOutsideThisEl(t), e))
          do {
            if (e[j])
              if (
                e[j]._onDragOver({ clientX: ct.clientX, clientY: ct.clientY, target: t, rootEl: e }) &&
    ...
    _onTouchMove: function (t) {
      if (st) {
        ...
        Z &&
          (r ? ((r.e += a - (ut || 0)), (r.f += l - (dt || 0))) : (r = { a: 1, b: 0, c: 0, d: 1, e: a, f: l }),
          (r = "matrix("
            .concat(r.a, ",")
            .concat(r.b, ",")
            .concat(r.c, ",")
      ...
      if (!Z) {
        ...
        if (Ot) {
          ...
          bt !== document.body && bt !== document.documentElement
            ? (bt === document && (bt = O()), (e.top += bt.scrollTop), (e.left += bt.scrollLeft))
            : (bt = O()),
            (_t = E(bt));
        }
        I((Z = q.cloneNode(!0)), n.ghostClass, !1),
          ...
          P(
            Z,
            "transform-origin",
            (ht / parseInt(Z.style.width)) * 100 + "% " + (ft / parseInt(Z.style.height)) * 100 + "%"
          );
      }
    },
    ...
    _onDragOver: function (n) {
      ...
      if (!Ct) {
        if (
          ...
          return p;
        if (q.contains(n.target) || (l.animated && l.animatingX && l.animatingY) || f._ignoreWhileAnimating === l)
          return O(!1);
        if (
          ((wt = !1),
          c &&
            ...
            (u
              ? d || (i = V !== $)
              : lt === this || ((this.lastPutMode = at.checkPull(this, c, q, n)) && s.checkPut(this, c, q, n))))
        ) {
          if (((r = "vertical" === this._getDirection(n, l)), (o = k(q)), T("dragOverValid"), Bt.eventCanceled))
            return p;
          if (i)
            return (
              (V = $),
          ...
          if (
            ...
            ((function (t, e, n) {
              ...
              return e
                ? t.clientX > n.right + 10 || (t.clientX <= n.right && t.clientY > n.bottom && t.clientX >= n.left)
                : (t.clientX > n.right && t.clientY > n.top) || (t.clientX <= n.right && t.clientY > n.bottom + 10);
            })(n, r, this) &&
              !g.animated)
          ) {
            if (g === q) return O(!1);
            if (((l = g && a === n.target ? g : l) && (w = k(l)), !1 !== Ft($, a, q, o, l, w, n, !!l)))
              return x(), g && g.nextSibling ? a.insertBefore(q, g.nextSibling) : a.appendChild(q), (V = a), A(), O(!0);
          } else if (
            g &&
            (function (t, e, n) {
            ...
            if (
              ...
              for (var _ = B(q); (y = V.children[(_ -= v)]) && ("none" === P(y, "display") || y === Z); );
      ...
      function O(t) {
        return (
          ...
          e.dragoverBubble || n.rootEl || l === document || (q.parentNode[j]._isOutsideThisEl(n.target), t || Xt(n)),
      ...
      function A() {
        (ot = B(q)),
          (rt = B(q, e.draggable)),
          U({ sortable: f, name: "change", toEl: a, newIndex: ot, newDraggableIndex: rt, originalEvent: n });
      }
    },
    ...
    _onDrop: function (t) {
      ...
      (ot = B(q)),
        ...
        Bt.eventCanceled ||
          ...
          P(q, "transform", ""),
          t &&
            (pt && (t.cancelable && t.preventDefault(), n.dropBubble || t.stopPropagation()),
            Z && Z.parentNode && Z.parentNode.removeChild(Z),
            ($ === V || (lt && "clone" !== lt.lastPutMode)) && tt && tt.parentNode && tt.parentNode.removeChild(tt),
            q &&
            ...
            (0 == T && 0 == p) ||
              ...
              (Zt[d].pid = setInterval(
                function () {
                  ...
                  ("function" == typeof i &&
                    "continue" !== i.call(Bt.dragged.parentNode[j], e, t, n, qt, Zt[this.layer].el)) ||
          ...
          (t.prototype = {
            ...
            clone: function (t) {
              var e = t.sortable,
                ...
                t = t.cancel;
              this.isMultiDrag &&
                (this.options.removeCloneOnHide || (ce.length && re === e && (pe(!0, n), o("clone"), t())));
            },
                ...
                if (!fe)
                  if (
                    ...
                    ce.splice(ce.indexOf(ae), 1),
                      (ie = null),
                      W({ sortable: i, rootEl: n, name: "deselect", targetEl: ae, originalEvent: e });
                  else {
                    if (
                      (ce.push(ae),
                      W({ sortable: i, rootEl: n, name: "select", targetEl: ae, originalEvent: e }),
                      e.shiftKey && ie && i.el.contains(ie))
                    ) {
                      var p = B(ie),
                        t = B(ae);
                      if (~p && ~t && p !== t)
                        for (var g, m = p < t ? ((g = p), t) : ((g = t), p + 1); g < m; g++)
                          ~ce.indexOf(f[g]) ||
                            (I(f[g], h.selectedClass, !0),
                            ce.push(f[g]),
                            W({ sortable: i, rootEl: n, name: "select", targetEl: f[g], originalEvent: e }));
                    } else ie = ae;
                    re = s;
                  }
                fe &&
                    ...
                    de ||
                      (h.animation &&
                        ...
                        ce.forEach(function (t) {
                          ...
                          (t.thisAnimationDuration = null),
                            t !== ae &&
                              ((e = he ? k(t) : c), (t.fromRect = e), s.addAnimationState({ target: t, rect: e }));
                        })),
                      ge(),
                      ce.forEach(function (t) {
              ...
              return (
                ce.forEach(function (t) {
                  ...
                  o.push({ multiDragElement: t, index: t.sortableIndex }),
                    (e = he && t !== ae ? -1 : he ? B(t, ":not(." + n.options.selectedClass + ")") : B(t)),
