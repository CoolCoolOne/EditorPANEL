...
$project_roomname = str_replace("&","-",$_POST['project_roomname']);
$project_oldroomname = str_replace("&","-",str_replace(">  ",">",str_replace(" <b>","<b>", str_replace("  <b>","<b>", $_POST['project_oldroomname']))));
...
$hard_trimmed__project_oldroomname = str_replace(" ","",str_replace("ö","o",str_replace(["ä","å"],"a",str_replace(['?','</b>','<b>','<br>',' '], "", strtolower($project_oldroomname)))));
